...
public class SelectContactActivity extends AppCompatActivity {
    ...
    * */
    ...
    public void init()
    {
        ...
        final SendContactInfo sendContactInfo=new SendContactInfo();
        ...
        adapter.setOnClickListener(new SelectContactItemAdapter.ClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                try{
                    tcpClient.initInetAddress(InetAddress.getByName(contactInforList.get(position).getIpAddress()));
                ...
                }catch (UnknownHostException e)
                {
                  ...
                  //  MainActivity.sexecutorService.submit(tcpClient);
                    SelectContactActivity.this.startActivity(new Intent(SelectContactActivity.this,SendProgressActivity.class));
            }
